...
namespace ConnectedHierarchicModel
{
    ...
    public class ConnectedHierarchicNetwork : AbstractNetwork
    {
        public ConnectedHierarchicNetwork(String rName,
            ResearchType rType,
        ...
        {
            networkGenerator = new ConnectedHierarchicGenerator();
