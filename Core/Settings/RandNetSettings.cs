...
namespace Core.Settings {
    ...
    public static class RandNetSettings {
        static private String defaultDirectory =
            Path.Combine(Directory.GetParent(Directory.GetCurrentDirectory()).FullName, "xRandNet");
        ...
        static public String LoggingDirectory {
            get { return (loggingDirectory == "") ? Path.Combine(defaultDirectory, "Logging") : loggingDirectory; }
            set {
        ...
        static public String StorageDirectory {
            get { return (storageDirectory == "") ? Path.Combine(defaultDirectory, "Results") : storageDirectory; }
            set {
        ...
        static public String TracingDirectory {
            get { return (tracingDirectory == "") ? Path.Combine(defaultDirectory, "Tracing") : tracingDirectory; }
            set {
        ...
        static public String StaticGenerationDirectory {
            get {
                return (staticGenerationDirectory == "")
                    ? Path.Combine(defaultDirectory, "Tracing")
                    : staticGenerationDirectory;
            }
            set {
        ...
        static public String MatrixConvertionToolDirectory {
            get {
                return (matrixConvertionToolDirectory == "")
                    ? Path.Combine(defaultDirectory, "Tracing")
                    : matrixConvertionToolDirectory;
            }
            set {
        ...
        static public String ModelCheckingToolDirectory {
            get {
                return (modelCheckingToolDirectory == "")
                    ? Path.Combine(defaultDirectory, "Tracing")
                    : modelCheckingToolDirectory;
            }
            set {
        ...
        static public String DataConvertionToolDirectory {
            get {
                return (dataConvertionToolDirectory == "")
                    ? Path.Combine(defaultDirectory, "Results")
                    : dataConvertionToolDirectory;
            }
            set {
        ...
        static public void InitializeLogging(String fileName) {
            ...
            if (fileName == "") {
                ...
                file.FileName = Path.Combine(LoggingDirectory, fileName + ".log");
